...
class CharacterEditorState extends MusicBeatState
{
  ...
  function addCharacterUI()
  {
    ...
    imageInputText = new FlxUIInputText(15, 30, 200, 'characters/nopeboy_2d', 8);
  ...
  function addAnimationsUI()
  {
    ...
    animationTransCheckBox = new FlxUICheckBox(animationNameInputText.x + 170, (animationNameInputText.y - 1) + 40, null, null, "Does it have a transition?",
      100);
    ...
    var json =
      {
        ...
        "whoDoneWhat": char.whoDoneWhat,

        "_editor_isPlayer": char._editor_isPlayer
      };
