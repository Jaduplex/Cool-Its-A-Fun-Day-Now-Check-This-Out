...
class ChartingState extends MusicBeatState
{
  ...
  **/
  ...
  override function create()
  {
    ...
    DiscordClient.changePresence("Chart Editor", StringTools.replace(_song.song, '-', ' '), null, '-menus');
    #end
    ...
    var eventIcon:FlxSprite = new FlxSprite(-GRID_SIZE - 5, -90).loadGraphic(Paths.image('ui/eventArrow'));
    leftIcon = new HealthIcon('bf');
    rightIcon = new HealthIcon('mark');
  ...
  function onSaveError(_):Void
  {
    ...
    _file.removeEventListener(IOErrorEvent.IO_ERROR, onSaveError);
    _file = null;
    throw "ERROR SAVING CHART! HOW? IDFK";
  }
